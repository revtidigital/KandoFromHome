...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    form2Badge: "Share your ideas and suggestions. Your thoughts help us to grow better, together.",
    ...
    privacySec3Body: "All submitted data is stored securely using encryption and server object storage with signed URL access controls. Access is strictly restricted to authorized administrative personnel with role-based access controls and detailed audit logging.",
    ...
    termsSec2Body: "Each employee is permitted exactly one submission against their valid Employee ID. Submission includes Form 1 (Personal details & up to 2 photos max 5MB each) and Form 2 (1 video max 40MB & CEO Reflection).",
    ...
    form1SubmitBtn: "Submit your Kando Moment",
  ...
  hi: {
    ...
    form1Badge: "अपने परिवार का कांडो मोमेंट हमारे साथ साझा करें।",
    ...
    form2Badge: "अपने विचार और सुझाव साझा करें। आपके विचार हमें और बेहतर बनने में मदद करते हैं।",
    ...
    privacySec3Body: "सभी जमा किया गया डेटा एन्क्रिप्शन और सर्वर ऑब्जेक्ट स्टोरेज में सुरक्षित रूप से संग्रहीत किया जाता है। पहुँच केवल अधिकृत प्रशासनिक कर्मियों तक ही सीमित है।",
    ...
    termsSec2Body: "प्रत्येक कर्मचारी को अपनी वैध कर्मचारी आईडी के विरुद्ध केवल एक प्रविष्टि की अनुमति है। प्रविष्टि में फॉर्म 1 (अधिकतम 2 तस्वीरें, 5MB प्रत्येक) और फॉर्म 2 (1 वीडियो, अधिकतम 40MB और सीईओ विचार) शामिल हैं।",
    ...
    form1SubmitBtn: "अपना कांडो मोमेंट जमा करें",
  ...
  ta: {
    ...
    form1Badge: "உங்கள் குடும்பத்தின் காண்டோ தருணத்தை எங்களுடன் பகிரவும்.",
    ...
    form2Badge: "உங்கள் யோசனைகள் மற்றும் பரிந்துரைகளைப் பகிரவும். உங்கள் எண்ணங்கள் நாங்கள் இணைந்து சிறப்பாக வளர உதவுகின்றன.",
    ...
    privacySec3Body: "அனைத்து தரவுகளும் பாதுகாப்பாக என்க்ரிப்ட் செய்யப்பட்டு சேமிக்கப்படும்.",
    ...
    form1SubmitBtn: "உங்கள் காண்டோ தருணத்தைச் சமர்ப்பிக்கவும்",

...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    privacySec3Body: "All submitted data is stored securely in encrypted databases and server object storage with signed URL access controls. Access is strictly restricted to authorized administrative personnel with role-based access controls and detailed audit logging.",
  ...
  hi: {
    ...
    privacySec3Body: "सभी जमा किया गया डेटा एन्क्रिप्टेड डेटाबेस और सर्वर ऑब्जेक्ट स्टोरेज में सुरक्षित रूप से संग्रहीत किया जाता है। पहुँच केवल अधिकृत प्रशासनिक कर्मियों तक ही सीमित है।",
  ...
  ta: {
    ...
    privacySec3Body: "அனைத்து தரவுகளும் பாதுகாப்பாக என்க்ரிப்ட் செய்யப்பட்ட சேமிப்பகத்தில் சேமிக்கப்படும்.",

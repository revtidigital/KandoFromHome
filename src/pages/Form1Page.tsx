              ...
              <div className="field">
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    id="ein"
                    type="text"
                    className={formData.empId.trim() && ((!hasNoEmpId && idCheckStatus === 'invalid') || errors.empId) ? 'has-error' : ''}
              ...
              <div className="field">
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    id="phone"
                    type="tel"
                    className={formData.phone.trim() && hasNoEmpId && (idCheckStatus === 'invalid' || errors.empId) ? 'has-error' : ''}

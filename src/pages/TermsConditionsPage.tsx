    ...
    <div className="container" style={{ padding: '40px 20px', maxWidth: '900px' }}>
      <div className="glass-panel" style={{ padding: '40px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', color: '#CBD5E1', lineHeight: 1.7 }}>
          ...
          <section>
            <h3 style={{ color: 'white', fontSize: '1.2rem', marginBottom: '8px' }}>{t.termsSec1Title}</h3>
            <p>{t.termsSec1Body}</p>
          </section>

          <section>
            <h3 style={{ color: 'white', fontSize: '1.2rem', marginBottom: '8px' }}>{t.termsSec2Title}</h3>
            <p>{t.termsSec2Body}</p>
          </section>

          <section>
            <h3 style={{ color: 'white', fontSize: '1.2rem', marginBottom: '8px' }}>{t.termsSec3Title}</h3>
            <p>{t.termsSec3Body}</p>
          </section>

          <section>
            <h3 style={{ color: 'white', fontSize: '1.2rem', marginBottom: '8px' }}>{t.termsSec4Title}</h3>
            <p>{t.termsSec4Body}</p>
          </section>
